import Challenge.Bls12381G1Add.Reference.Proofs.FrozenStackCertificate

set_option warningAsError true

/-!
# Chunked G1ADD stack-certificate checking

The verified checker is pure, but reducing all 910 finite entries in one
