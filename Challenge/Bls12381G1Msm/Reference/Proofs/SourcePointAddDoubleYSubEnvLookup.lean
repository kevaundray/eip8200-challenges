...
private theorem yMulEnv_xHi (yst : EvmState) (out left right : U256) :
...
private theorem yMulEnv_xLo (yst : EvmState) (out left right : U256) :
...
private theorem yMulEnv_tempHi (yst : EvmState) (out left right : U256) :
...
private theorem yMulEnv_tempLo (yst : EvmState) (out left right : U256) :
...
theorem pointAddDoubleYSubConcreteEnv_xHi (yst : EvmState)
  ...
  exact yMulEnv_xHi yst out left right
...
theorem pointAddDoubleYSubConcreteEnv_xLo (yst : EvmState)
  ...
  exact yMulEnv_xLo yst out left right
...
theorem pointAddDoubleYSubConcreteEnv_tempHi (yst : EvmState)
  ...
  exact yMulEnv_tempHi yst out left right
...
theorem pointAddDoubleYSubConcreteEnv_tempLo (yst : EvmState)
  ...
  exact yMulEnv_tempLo yst out left right
