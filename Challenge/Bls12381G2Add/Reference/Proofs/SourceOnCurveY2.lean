...
theorem onCurveY2_canonical (yst : EvmState) (y : U256)
  ...
  exact fp2MulFinalState_canonical_of_low yst (BitVec.ofNat 256 2048) y y
    hy hy hyEnd hyLow hyEnd hyLow (by norm_num) (by norm_num)
...
theorem onCurveY2_toLawful (yst : EvmState) (y : U256)
  ...
  rw [pow_two]
  exact fp2MulFinalState_toLawful_mul_of_low yst
    (BitVec.ofNat 256 2048) y y hy hy hyEnd hyLow hyEnd hyLow
